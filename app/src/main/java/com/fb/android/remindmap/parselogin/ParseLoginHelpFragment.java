                            ...
                            public void done(ParseException e) {
                                ...
                                if (e == null) {
                                    instructionsTextView
                                            .setText(R.string.parse_login_help_email_sent);
                                    emailField.setVisibility(View.INVISIBLE);
                                    submitButton
                                            .setText(R.string.parse_login_help_login_again_button_label);
                                    emailSent = true;
                                } else {
                                    debugLog(getString(R.string.parse_login_warning_password_reset_failed) +
                                            e.toString());
                                    if (e.getCode() == ParseException.INVALID_EMAIL_ADDRESS ||
                                        ...
                                        showToast(R.string.parse_login_help_submit_failed_unknown);
                                    }
                                }
                            }
                        });
