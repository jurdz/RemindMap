...
public class PlaceProvider extends ContentProvider implements LocationFoundInterface {

    public static final String AUTHORITY = "com.fb.android.remindmap.maps.PlaceProvider";
    ...
    String mKey = "key=AIzaSyDxdUyZYSpglkqZWQrncwh3SMQ-r16C6uE";
    // Current location.
    String location;
    // Radius within which to bias searches.
    String radius = "radius=2000";

    // Gets current location at time of search.

    @Override
    public void onLocationFound() {

        String latitude = String.valueOf(mLocationManager.getLocation().getLatitude());
        String longitude = String.valueOf(mLocationManager.getLocation().getLongitude());
    ...
    public Cursor query(
        ...
        switch (mUriMatcher.match(uri)) {
            ...
            case DETAILS:
                ...
                for (int j = 0; j < detailsList.size(); j++) {
                    HashMap<String, String> hMapDetails = detailsList.get(j);
                    mCursor.addRow(new String[]{hMapDetails.get("formatted_address"),
                            hMapDetails.get("lat"), hMapDetails.get("lng")});
                }
                c = mCursor;
                break;
    ...
    private String getPlaceDetailsUrl(String ref) {
        ...
        String parameters = reference + "&" + sensor + "&" + mKey + "&" + location + "&" + radius;
    ...
    private String getPlacesUrl(String qry) {
        ...
        // Building the parameters to the web service
        String parameters = qry + "&" + types + "&" + sensor + "&" + mKey + "&" + location + "&" + radius;
