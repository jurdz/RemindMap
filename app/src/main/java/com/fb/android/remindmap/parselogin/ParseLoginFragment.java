...
public class ParseLoginFragment extends ParseLoginFragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.parse_login_fragment, parent, false);
        ImageView appWordmark = (ImageView) v.findViewById(R.id.app_wordmark);
                    ...
                    ParseUser.logInInBackground(username, password, new LogInCallback() {
                        ...
                        public void done(ParseUser user, ParseException e) {
                            ...
                            if (user != null) {
                                ...
                                loadingFinish();
                                if (e != null) {
                                    debugLog(getString(R.string.parse_login_warning_parse_login_failed) +
                                            e.toString());
    ...
    private LogInCallback facebookLoginCallbackV4 = new LogInCallback() {
        ...
        public void done(ParseUser user, ParseException e) {
            ...
            if (user == null) {
                loadingFinish();
                if (e != null) {
                    showToast(R.string.parse_facebook_login_failed_toast);
                    debugLog(getString(R.string.parse_login_warning_facebook_login_failed) +
                            e.toString());
                }
            } else if (user.isNew()) {
                                ...
                                if (fbUser != null && parseUser != null
                                    ...
                                    parseUser.saveInBackground(new SaveCallback() {
                                        ...
                                        public void done(ParseException e) {
                                            if (e != null) {
                                                debugLog(getString(
                                                        R.string.parse_login_warning_facebook_login_user_update_failed) +
                                                        e.toString());
                                            }
                                            loginSuccess();
                                        }
    ...
    private boolean allowParseLoginAndSignup() {
        ...
        if (usernameField == null) {
            debugLog(R.string.parse_login_warning_layout_missing_username_field);
        }
        if (passwordField == null) {
            debugLog(R.string.parse_login_warning_layout_missing_password_field);
        }
        if (parseLoginButton == null) {
            debugLog(R.string.parse_login_warning_layout_missing_login_button);
        }
        if (parseSignupButton == null) {
            debugLog(R.string.parse_login_warning_layout_missing_signup_button);
        }
        if (parseLoginHelpButton == null) {
            debugLog(R.string.parse_login_warning_layout_missing_login_help_button);
        }
        ...
        if (!result) {
            debugLog(R.string.parse_login_warning_disabled_username_password_login);
        }
        return result;
    }
    ...
    private boolean allowFacebookLogin() {
        ...
        if (facebookLoginButton == null) {
            debugLog(R.string.parse_login_warning_disabled_facebook_login);
            return false;
        } else {
            return true;
        }
